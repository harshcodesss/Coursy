  ...
  return (
    <motion.div
      animate={{
        ...
        y: visible ? 20 : 0,
        border: visible ? "1px solid rgba(255, 255, 255, 0.15)" : "none", // conditional border
      }}
      transition={{
        type: "spring",
        stiffness: 200,
  ...
  return (
    <motion.div
      animate={{
        ...
        borderRadius: visible ? "2.5rem" : "2rem",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
      ...
      className={cn(
        ...
        visible && "bg-zinc-900/80 backdrop-blur-md border border-zinc-800/50",
        className,
      )}
    >
      {children}
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-large text-white dark:text-white">Coursy</span>
    </a>
  );
};
